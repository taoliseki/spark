...
class KryoMessageCodec extends ByteToMessageCodec<Object> {
  ...
  protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out)
    ...
    try {
      ...
      LOG.info("Decoded message of type {} ({} bytes)",
  ...
  protected void encode(ChannelHandlerContext ctx, Object msg, ByteBuf buf)
    ...
    LOG.info("tlitest  message type: " + msg.getClass().getName());
    LOG.info("tlitest msg: " + msg);

    ByteBuffer msgData = maybeEncrypt(serializer.serialize(msg));

    LOG.info("Encoded message of type {} ({} bytes)", msg.getClass().getName(),
      msgData.remaining());
